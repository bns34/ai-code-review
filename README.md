...
## Run without an action (Windows)

### To test this out without creating a workflow and a PR, run these:

```bash
set INPUT_repository_owner=...
set INPUT_repo=...
set INPUT_owner=...
set INPUT_pr_number=...
set INPUT_token=...
set INPUT_ai_provider=...
set INPUT_deepseek_api_key=...
set INPUT_deepseek_model=...
npm start
```
